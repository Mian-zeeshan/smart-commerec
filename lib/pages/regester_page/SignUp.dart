                      ...
                      Container(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              SizedBox(height: 20.h,),
                              Text("Regester your account with email and password", style: fontUtils.description(theme.textColor),textAlign: TextAlign.center,),
                              SizedBox(height: 20.h,),
  utils.borderedInputField("Username", theme.grayColor.withOpacity(0.7), theme.buttonColor.withOpacity(0.7), TablerIcons.user, theme.buttonColor.withOpacity(0.7), theme.textColor, null, null, null, false, true, usernameController, (val) {

                              }, isError: usernameError, errorMessage: usernameErrorMessage, errorColor: theme.redColor),
                              ...
                              SizedBox(height: 20.h,),
                                 utils.button(theme.buttonColor, "SIGN UP", theme.whiteColor, TablerIcons.user_plus, theme.whiteColor, null, null, ()async{
                              ...
                              setState(() {
                                ...
                                EasyLoading.show(status: "Creating...");
                                  ...
                                  var data={
                                "username": usernameController.text.toLowerCase().toString().trim(),
                                "email":emailController.text.toString().trim(),
                                "password": passwordController.text.trim(),
                                // "deviceType": GetPlatform.isAndroid ? "Android" : "IOS"
                              };

                              await    userController.  signUp(data, theme);
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("Do you have an account? Log In", style: fontUtils.small(theme.textColor),),
                                  Expanded(
                                    child: Container(
                                      height: 1,
